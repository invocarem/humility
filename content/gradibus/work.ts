...
export const gradibus: Work = {
  ...
  source:
    "Working Latin in content/gradibus/latin.md (PL 182 with SBO supplements; previous abridged pride-half as latin-backup.md). Author file 01_steps_of_humility_and_pride.md is left unchanged.",
